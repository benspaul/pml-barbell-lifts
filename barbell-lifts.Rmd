...
# the accuracy is 99.6%, indicating an extremely low out of sample error rate.
# in addition, the sensitivity and specificity for every class is >= 99%, again indicating very low out of sample error.
